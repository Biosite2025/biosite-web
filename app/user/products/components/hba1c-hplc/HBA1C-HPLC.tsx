...
export default function HBA1CHPLC() {
	...
	useEffect(() => {
		...
		const preloadImages = () => {
			productImages.forEach((src: string) => {
		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			...
			>
				...
				<div className="absolute inset-0 w-full h-full z-10">
					<ParticlesBackground containerId="hba1c-hplc-particles" />
				</div>
				...
				<div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
					...
					>
						<motion.h1
							...
							className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-6 sm:mb-8 drop-shadow-2xl max-[912px]:text-4xl"
						>
							HBA1C - HPLC
						</motion.h1>
						<motion.div
						...
						>
							Precision HPLC systems for accurate HBA1C measurement, delivering reliable results for diabetes monitoring and patient care excellence
						</motion.p>
					</motion.div>
			...
			>
				<div className="max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center max-[912px]:px-3">
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-[912px]:text-sm max-[912px]:mb-4">
						Our team of specialists is ready to help you find the perfect HBA1C - HPLC solution for your laboratory needs.
					</p>
					<motion.a
						href="/user/contact"
						whileHover={{ scale: 1.05 }}
