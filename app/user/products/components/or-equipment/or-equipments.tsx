...
const category = {
  id: 'or-equipments',
  title: 'OR Equipments',
  description: 'Advanced operating room equipment for surgical precision, safety, and efficiency.',
  folder: 'or-equipments',
};
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
          ...
          >
            ...
            >
              Advanced operating room equipment for surgical precision, safety, and efficiency.
            </motion.p>
          </motion.div>
