  ...
  const [isModalOpen, setIsModalOpen] = useState(false);
	...
	useEffect(() => {
		...
		const productData = [
			{
				id: 1,
				name: 'Genrui PA-120 Pipettor',
				image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/products/pipettors/genrui-pa-120.png',
				description: 'Genrui PA-120: Ergonomic and accurate single channel pipettor for precise liquid handling.'
			},
			{
				id: 2,
				name: 'Genrui PA-50 Pipettor',
				image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/products/pipettors/genrui-pa-50.png',
				description: 'Genrui PA-50: Multi-channel pipettor designed for high-throughput applications and consistent results.'
			},
			{
				id: 3,
				name: 'Genrui PA-54 Pipettor',
				image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/products/pipettors/genrui-pa-54.png',
				description: 'Genrui PA-54: Adjustable volume pipettor for flexible and reliable laboratory work.'
			},
			{
				id: 4,
		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			...
			>
				...
				<div className="absolute inset-0 w-full h-full z-0">
					<Image
						src="https://res.cloudinary.com/dmvyhrewy/image/upload/w_800,q_auto:low,f_auto/v1763530316/biosite-assets/dakewe/bg-dakewe.jpg"
						alt="Pipettors Background"
						fill
