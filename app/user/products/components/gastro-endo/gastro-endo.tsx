...
const category = {
  ...
  description: 'Innovative gastroenterology and endoscopy equipment for advanced diagnostic and therapeutic procedures.',
  folder: 'gastro-endo',
};
    ...
    const productData = [
      {
        id: 1,
        name: 'C6 HD / C6A HD',
        image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/medical-equipments/C6 HD&C6A HD.png',
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
          ...
          >
            ...
            >
              Innovative gastroenterology and endoscopy equipment for advanced diagnostic and therapeutic procedures.
            </motion.p>
          </motion.div>
      ...
      >
        <div className="max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center max-[912px]:px-3">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4 md:mb-6 max-[912px]:text-xl">
            Ready to Upgrade Your Endoscopy Suite?
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-[912px]:text-sm max-[912px]:mb-4">
            Our team of specialists is ready to help you find the perfect gastroenterology and endoscopy equipment for your clinical needs.
          </p>
          <motion.a
            href="/user/contact"
            whileHover={{ scale: 1.05 }}
