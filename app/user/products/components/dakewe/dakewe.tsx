...
export default function Dakewe() {
	...
	useEffect(() => {
		...
		const productData = [
			...
			{ id: 3, name: 'HP300', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/products/dakewe-new/DAKEWE HP300.png', description: 'HP300 Dakewe Automatic tissue processor vacuum tissue dehydration machine for histopathology' },
			{ id: 4, name: '6520 Cryostat', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/products/dakewe-new/DAKEWE 6520.png', description: 'The Dakewe 6520 Rotary Microtome Cryostat delivers reliable section quality with precise mechanical movement, high efficiency, and a smart temperature control system for optimal specimen preservation. Features include a hard wheel with lock, slide placement area, numbered freezing plates, anti-frost glass door, rapid cooling peltier station, color touch screen, anti-roll plate, blade holder, UV disinfection, and advanced configuration UI. Section thickness: 1–100 μm, trimming thickness: 1–600 μm, chamber temp: -35°C to +40°C, freezing plate temp: down to -40°C, and more.' },
			...
			{ id: 6, name: 'DP360 + CS500 Combo', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/products/dakewe-new/DAKEWE DP360 + CS500.png', description: 'High efficiency and fully Automated staining and coverslipping process, no waiting needed. 	Excellent quality control system and ready-to-use consumables keep each slide consistent.' },
			{ id: 7, name: 'SurePrint C7', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/products/dakewe-new/SurePrint C7.webp', description: 'The Dakewe SurePrint C7 is a compact UV laser cassette printer that delivers fast, high-resolution, durable printing on all cassette types—without ink or ribbons—ideal for efficient histology workflows.' },
			{ id: 8, name: 'SurePrint S10 & S10 PRO', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/products/dakewe-new/SurePrint S10&S10 PRO.png', description: 'A compact UV laser slide printer delivering permanent, high-resolution (2500 dpi) markings without consumables. Holds up to 150 slides in one hopper, supports rich content (alphanumeric, barcodes, graphics), offers both simple and advanced interface modes, and integrates with LIS systems. Minimal maintenance and durable prints resistant to processing solvents.' }
		];
