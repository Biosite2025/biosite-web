...
export default function Biorefrigerators() {
	...
	useEffect(() => {
		...
		const productData = [
			{ id: 1, name: 'HYC-68&68A', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HYC-68&68A.png', description: 'Compact 2–8 °C medical refrigerator for vaccines, reagents, and pharmaceuticals. Ideal for clinics and small labs.' },
			{ id: 2, name: 'HYC-118&118A', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HYC-118&118A.png', description: 'Small-capacity 2–8 °C biomedical refrigerator with precise temperature control for routine medical storage.' },
			{ id: 3, name: 'HYC-290', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HYC-290.png', description: 'Medium-capacity pharmacy refrigerator designed for stable storage of medicines, vaccines, and laboratory reagents.' },
			{ id: 4, name: 'HYC-390&390F', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HYC-390&390F.png', description: 'Large 2–8 °C medical refrigerator suitable for hospitals and laboratories; "F" version includes advanced airflow or frost-free features.' },
			{ id: 5, name: 'HYC-610', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HYC-610.png', description: 'High-capacity biomedical refrigerator for centralized medical storage with uniform cooling and safety alarms.' },
			{ id: 6, name: 'HYC-940&940F', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HYC-940&940F.png', description: 'Extra-large medical refrigerator for hospitals and blood banks; "F" model offers enhanced cooling performance.' },
			{ id: 7, name: 'HYC-1378', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HYC-1378.png', description: 'Ultra-large pharmacy / biomedical refrigerator designed for bulk storage in major hospitals and research facilities.' },
			{ id: 8, name: 'HXC-149', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HXC-149.png', description: 'Compact blood bank refrigerator for safe storage of whole blood and blood components at controlled temperatures.' },
			{ id: 10, name: 'HXC-429', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HXC-429.png', description: 'Medium-capacity blood bank refrigerator with precise temperature stability and monitoring.' },
			{ id: 11, name: 'HXC-429T', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HXC-429T.png', description: 'Blood bank refrigerator with dual temperature display/recording for enhanced traceability and compliance.' },
			{ id: 12, name: 'HXC-629', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HXC-629.png', description: 'Large-capacity blood bank refrigerator suitable for hospitals and transfusion centers.' },
			{ id: 13, name: 'HXC-629T', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HXC-629T.png', description: 'Advanced blood bank refrigerator with temperature recording and alarm systems for regulatory compliance.' },
			{ id: 14, name: 'HXC-1369', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HXC-1369.png', description: 'Extra-large blood bank refrigerator for high-volume blood storage in central blood banks.' },
			{ id: 15, name: 'HXC-1369T', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biorefrigerators/HXC-1369T.png', description: 'High-capacity blood bank refrigerator with temperature recording, designed for critical blood storage and audit-ready environments.' }
		];
		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			...
			>
				...
				<div className="absolute inset-0 w-full h-full z-10">
					<ParticlesBackground containerId="biorefrigerators-particles" />
				...
				<div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
					...
					>
						...
						>
							Advanced biorefrigerators systems and equipment for comprehensive laboratory diagnostics
						</motion.p>
					</motion.div>
			...
			>
				<div className="max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center max-[912px]:px-3">
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-[912px]:text-sm max-[912px]:mb-4">
						Our team of specialists is ready to help you find the perfect biorefrigerators solution for your laboratory needs.
					</p>
					<motion.a
						href="/user/contact"
						whileHover={{ scale: 1.05 }}
