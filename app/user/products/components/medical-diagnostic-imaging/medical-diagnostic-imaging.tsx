...
const category = {
	...
	folder: 'medical-diagnostic-imaging',
};
				...
				>
					...
					<div className="space-y-3 sm:space-y-4 max-[912px]:space-y-2">
						...
						<p className="text-sm sm:text-base text-gray-600 leading-relaxed max-[912px]:text-xs">
							Professional-grade laboratory equipment designed for precision, reliability, and superior performance in medical diagnostic imaging applications.
						</p>
		...
		>
			...
			<div className="p-4 sm:p-5 md:p-6 max-[912px]:p-3">
				...
				<p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 line-clamp-2 max-[912px]:text-xs max-[912px]:mb-2">
					Professional medical diagnostic imaging equipment engineered for precision and reliability.
				</p>
...
export default function MedicalDiagnosticImaging() {
	...
	useEffect(() => {
		...
		const productData = [
			{ id: 1, name: 'Dakewe 6520 Cryostat', image: '/asset/products/medical-diagnostic-imaging/dakewe-6520-cryostat.png' },
			{ id: 2, name: 'Sakura Accu-Cut SRM 200', image: '/asset/products/medical-diagnostic-imaging/sakura-accu-cut-srm-200.png' }
		];
