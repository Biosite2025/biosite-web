...
export default function Poct() {
	...
	useEffect(() => {
		...
		const productData = [
			...
			{ id: 7, name: 'On Call Extra', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/poct/On-Call-Extra.png', description: 'The On Call Extra Blood Glucose Monitoring System offers user friendly features for easier diabetes management at competitive prices. The smart and powerful data management is compatible with the On Call Diabetes Management Software.' },
