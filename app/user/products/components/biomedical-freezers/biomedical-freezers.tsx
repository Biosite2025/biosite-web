...
export default function BiomedicalFreezers() {
	...
	useEffect(() => {
		...
		const productData = [
			{ id: 1, name: 'DW-25L92', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biomedical-freezers/DW-25L92.png', description: 'Compact −25 °C medical freezer for safe storage of reagents, vaccines, plasma, and biological samples. Suitable for laboratories and small healthcare facilities.' },
			{ id: 2, name: 'DW-40L262', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biomedical-freezers/DW-40L262.png', description: 'Medium-capacity −40 °C biomedical freezer designed for long-term preservation of plasma, biological materials, and laboratory samples with stable temperature control.' },
			...
			{ id: 4, name: 'DW-40L348', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biomedical-freezers/DW-40L348.png', description: 'High-capacity −40 °C biomedical freezer for large-volume storage of biological samples, reagents, and plasma in clinical and research environments.' },
			{ id: 5, name: 'DW-40L508', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biomedical-freezers/DW-40L508.png', description: 'Extra-large −40 °C medical freezer designed for centralized laboratories and blood centers needing high-volume, stable ultra-low temperature storage.' },
			{ id: 6, name: 'DW-40W100', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biomedical-freezers/DW-40W100.png', description: 'Compact −40 °C chest freezer optimized for energy efficiency and uniform cooling, suitable for laboratories with limited space.' },
			{ id: 7, name: 'DW-40W255', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biomedical-freezers/DW-40W255.png', description: 'Mid-size −40 °C chest-type biomedical freezer providing reliable low-temperature storage with easy access and consistent cooling performance.' },
			{ id: 8, name: 'DW-40W380', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biomedical-freezers/DW-40W380.png', description: 'Large-capacity −40 °C chest freezer designed for bulk storage of biological materials in hospitals, research institutes, and blood banks.' },
			{ id: 9, name: 'DW-25L262', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/biomedical-freezers/DW-25L262.png', description: 'Upright −25 °C medical freezer for routine cold storage of pharmaceuticals, reagents, vaccines, and laboratory samples.' },
		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			...
			>
				...
				<div className="absolute inset-0 w-full h-full z-10">
					<ParticlesBackground containerId="biomedical-freezers-particles" />
				...
				<div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
					...
					>
						...
						>
							Advanced biomedical freezers systems and equipment for comprehensive laboratory diagnostics
						</motion.p>
					</motion.div>
			...
			>
				<div className="max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center max-[912px]:px-3">
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-[912px]:text-sm max-[912px]:mb-4">
						Our team of specialists is ready to help you find the perfect biomedical freezers solution for your laboratory needs.
					</p>
					<motion.a
						href="/user/contact"
						whileHover={{ scale: 1.05 }}
