...
const category = {
	...
	description: 'Advanced clinical microscopy systems and equipment for comprehensive laboratory diagnostics',
			...
			>
				...
				<div className="absolute inset-0 w-full h-full z-0">
					<Image
						...
						alt="Clinical Microscopy Background"
						fill
				...
				<div className="absolute inset-0 w-full h-full z-10">
					<ParticlesBackground containerId="clinical-microscopy-particles" />
				...
				<div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
					...
					>
						...
						>
							Advanced clinical microscopy systems and equipment for comprehensive laboratory diagnostics
						</motion.p>
					</motion.div>
			...
			>
				<div className="max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center max-[912px]:px-3">
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-[912px]:text-sm max-[912px]:mb-4">
						Our team of specialists is ready to help you find the perfect clinical microscopy solution for your laboratory needs.
					</p>
					<motion.a
						href="/user/contact"
						whileHover={{ scale: 1.05 }}
