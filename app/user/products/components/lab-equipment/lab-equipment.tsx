...
const category = {
	id: 'lab-equipment',
	title: 'Lab Equipment',
	description: 'Advanced lab equipment systems and equipment for comprehensive laboratory diagnostics',
				...
				>
					...
					<div className="space-y-3 sm:space-y-4 max-[912px]:space-y-2">
						...
						<p className="text-sm sm:text-base text-gray-600 leading-relaxed max-[912px]:text-xs">
							Professional-grade laboratory equipment designed for precision, reliability, and superior performance in lab equipment applications.
						</p>
		...
		>
			...
			<div className="p-4 sm:p-5 md:p-6 max-[912px]:p-3">
				...
				<p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 line-clamp-2 max-[912px]:text-xs max-[912px]:mb-2">
					Professional lab equipment equipment engineered for precision and reliability.
				</p>
...
export default function LabEquipment() {
	...
	useEffect(() => {
		...
		const productData = [
			{ id: 1, name: 'DLAB HP-500 PRO', image: '/asset/products/lab-equipment/dlab-hp-500-pro.png' },
			{ id: 2, name: 'DLAB DSC-100MH-2', image: '/asset/products/lab-equipment/dlab-dsc-100mh-2.png' }
		];
		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			...
			>
				...
				<div className="absolute inset-0 w-full h-full z-10">
					<ParticlesBackground containerId="lab-equipment-particles" />
				...
				<div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
					...
					>
						...
						>
							Advanced lab equipment systems and equipment for comprehensive laboratory diagnostics
						</motion.p>
					</motion.div>
			...
			>
				<div className="max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center max-[912px]:px-3">
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-[912px]:text-sm max-[912px]:mb-4">
						Our team of specialists is ready to help you find the perfect lab equipment solution for your laboratory needs.
					</p>
					<motion.a
						href="/user/contact"
						whileHover={{ scale: 1.05 }}
