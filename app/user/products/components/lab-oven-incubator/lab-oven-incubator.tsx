...
export default function LabOvenIncubator() {
	...
	useEffect(() => {
		...
		const productData = [
		  ...
		  { id: 9, name: 'Standard Incubator', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/lab-oven-incubator/Standard%20Incubator.png', description: 'The solution is widely used in bacteria, fungi and other microorganisms culture; as well as enzyme digestion reaction, ligation reaction, embedded incubation and other related constant temperature experiments.' },
		  ...
		  { id: 12, name: 'Climate Chamber - Compressor Series', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/lab-oven-incubator/HHS-810.png', description: 'Used for drug stability testing, food shelf-life testing, electronic component aging testing, microbiological research, sample storage.' },
		  { id: 13, name: 'CO₂ Incubator 168E front', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/lab-oven-incubator/CO%E2%82%82%20Incubator%20168E%20front.png', description: 'Haier Biomedical CO2 incubator with 90°C moist heat sterilization provides a safe and secure reproducible growth environment for cell cultures.' }
		];
		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			...
			>
				...
				<div className="absolute inset-0 w-full h-full z-10">
					<ParticlesBackground containerId="lab-oven-incubator-particles" />
				...
				<div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
					...
					>
						...
						>
							Advanced lab oven incubator systems and equipment for comprehensive laboratory diagnostics
						</motion.p>
					</motion.div>
			...
			>
				<div className="max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center max-[912px]:px-3">
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-[912px]:text-sm max-[912px]:mb-4">
						Our team of specialists is ready to help you find the perfect lab oven incubator solution for your laboratory needs.
					</p>
					<motion.a
						href="/user/contact"
						whileHover={{ scale: 1.05 }}
