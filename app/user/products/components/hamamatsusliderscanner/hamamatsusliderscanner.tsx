...
const categories = [
	{
		id: 'digital-slide-scanner',
		title: 'Digital Slide Scanner',
		description: 'Industry-leading NanoZoomer digital slide scanners for precision imaging',
		folder: 'Digital Slide Scanner',
	},
];
...
export default function HamamatsuSlideScanner() {
		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			...
			>
				...
				<div className="absolute inset-0 w-full h-full z-10">
					<ParticlesBackground containerId="hamamatsu-particles" />
				...
				<div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
					...
					>
						...
						>
							Industry-leading NanoZoomer digital slide scanners delivering unparalleled imaging precision, speed, and reliability for clinical diagnostics and research excellence
						</motion.p>
					</motion.div>
			...
			>
				<div className="max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center max-[912px]:px-3">
					<h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4 md:mb-6 max-[912px]:text-xl">
						Ready to Experience NanoZoomer Excellence?
					</h2>
					<p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-[912px]:text-sm max-[912px]:mb-4">
						Our team of specialists is ready to help you find the perfect digital slide scanning solution for your laboratory needs.
					</p>
					<motion.a
						href="/user/contact"
						whileHover={{ scale: 1.05 }}
