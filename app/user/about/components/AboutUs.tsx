...
const AboutUs = () => {
  return (
    <section id="about-us" className="w-full min-h-screen bg-white flex flex-col md:flex-row items-stretch relative overflow-hidden mb-20 mt-20">
      {/* Subtle background pattern */}
      <div className="absolute inset-0 opacity-5 bg-gradient-to-br from-blue-50 to-gray-50 pointer-events-none" />

      <div className="flex flex-col md:flex-row w-full h-full min-h-screen items-stretch px-0 m-0 relative z-10">
        {/* Left: Image with modern overlay effects */}
        <div className="relative w-full md:w-1/2 h-[300px] md:h-auto min-h-[300px] md:min-h-screen flex items-center justify-center overflow-hidden m-0 p-0 group">
        ...
        <div className="flex flex-col justify-center items-start w-full md:w-1/2 px-6 md:px-16 py-10 md:py-20 scale-110">
          ...
          <div className="text-2xl md:text-[23px] font-extrabold text-[#2356a8] mb-8 w-[500px] relative">
          ...
          <div className="text-[#444] text-base md:text-[13px] leading-relaxed space-y-5 w-[500px] max-w-2xl text-justify group">
