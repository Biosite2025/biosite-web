...
export default function Centrifuges() {
	...
	useEffect(() => {
		...
		const productData = [
			{ id: 1, name: 'Hermle LC-8', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/hermle-lc-8.png', description: 'Compact low-speed laboratory centrifuge designed for routine clinical and laboratory applications with simple operation.' },
			{ id: 2, name: 'Hermle Z206-A', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/hermle-z206-a.jpg', description: 'Small bench-top centrifuge suitable for clinical labs, offering reliable performance for daily sample separation.' },
			{ id: 3, name: 'Hermle Z207-A', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/hermle-z207-a.jpg', description: 'Versatile bench centrifuge for routine laboratory use with flexible rotor options and stable operation.' },
			{ id: 4, name: 'Hermle Z207-H', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/hermle-z207-h.jpg', description: 'High-speed version of the Z207 series, designed for more demanding laboratory applications requiring higher centrifugal force.' },
			{ id: 5, name: 'Hermle Z216-M', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/hermle-z216-m.png', description: 'Advanced microcentrifuge optimized for molecular biology and research applications with high-speed capability.' },
			{ id: 6, name: 'Hermle Z306', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/hermle-z306.png', description: 'Medium-capacity bench-top centrifuge for laboratories needing higher sample throughput and flexible configurations.' },
			{ id: 7, name: 'Hermle Z446-K', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/hermle-z446-k.png', description: 'High-performance refrigerated centrifuge suitable for clinical, research, and industrial laboratories requiring temperature control.' },
			{ id: 8, name: 'Hermle Z496-K', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/hermle-z496-k.png', description: 'Large-capacity refrigerated laboratory centrifuge designed for high-volume and high-speed applications in advanced labs.' },
			{ id: 9, name: 'Floor Standing Low-Speed Refrigerated Centrifuge', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/Floor%20Standing%20Low-Speed-Refrigerated-Centrifuge.png', description: 'Specifically designed for use in blood banks and  transfusion facilities.Widely applied in biopharmaceuticals, cell therapy, biological culture, vaccine production, universities and other related fields.' },
			{ id: 10, name: 'Floor-Standing Large-Capacity Refrigerated Centrifuge', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/Floor-Standing%20Large-Capacity%20Refrigerated%20Centrifuge.jpg', description: 'Haier Biomedical LX-100L1000R is a conventional centrifuge designed for biopharmaceuticals with large capacity 6L, which is widely used in fields such as biopharmaceuticals and academic research. It plays an important role in the processes of protein collection, separation, and purification for samples like macromolecular proteins and bacteria.' },
			{ id: 11, name: 'Floor-Standing High-Speed Refrigerated Centrifuge', image: 'https://biositeassets.sgp1.cdn.digitaloceanspaces.com/biosite-web/products/centrifuges/Floor-Standing%20High-Speed%20Refrigerated%20Centrifuge.jpg', description: 'Haier Biomedical LX-210L750R is a floor-standing highspeed refrigerated centrifuge features with 3L capacity and performance up to 47,400 xg, which is ideal for all-purpose use in the industrial and research sectors.' }
		];
		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			...
			>
				...
				<div className="absolute inset-0 w-full h-full z-10">
					<ParticlesBackground containerId="centrifuges-particles" />
				...
				<div className="relative z-10 max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center max-[912px]:px-3">
					...
					>
						...
						>
							Advanced centrifuges systems and equipment for comprehensive laboratory diagnostics
						</motion.p>
					</motion.div>
			...
			>
				<div className="max-w-4xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 text-center max-[912px]:px-3">
					...
					<p className="text-base sm:text-lg md:text-xl text-gray-200 mb-4 sm:mb-6 md:mb-8 max-[912px]:text-sm max-[912px]:mb-4">
						Our team of specialists is ready to help you find the perfect centrifuges solution for your laboratory needs.
					</p>
					<motion.a
						href="/user/contact"
						whileHover={{ scale: 1.05 }}
